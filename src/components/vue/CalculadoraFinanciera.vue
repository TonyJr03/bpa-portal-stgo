        ...
        <button
          ...
          :class="
            tabActiva === 'vista'
              ...
              : 'bg-white dark:bg-bpa-950/60 text-muted hover:bg-bpa-50 dark:hover:bg-bpa-800/30'
          "
        >
          <!-- tabler:coins -->
          <svg
        ...
        <div v-if="tabActiva === 'vista'" key="vista" class="space-y-5">
          ...
          <div class="flex items-center gap-3 flex-wrap">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                v-for="mon in vistaMonedasDisponibles"
                :key="mon.moneda"
                @click="vistaMoneda = mon.moneda"
                class="px-3 py-1.5 rounded-full text-xs font-semibold border transition-colors"
                :class="
                  vistaMoneda === mon.moneda
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div
                class="campo-numero flex items-center rounded-lg border border-bpa-200 dark:border-bpa-amber-800 bg-white dark:bg-bpa-950/80 overflow-hidden focus-within:ring-2 focus-within:ring-primary transition"
              >
                <input
                  v-model="vistaForm.monto"
                  type="number"
                  min="0"
                  step="0.1"
                  placeholder="0.00"
                ...
                <div class="flex flex-col self-stretch border-l border-bpa-200 dark:border-bpa-amber-800">
                  <button
                    type="button"
                    @click="ajustar(vistaForm, 'monto', 0.1, 0)"
            ...
            <div>
              ...
              <div class="flex gap-2">
                <div
                  class="campo-numero flex-1 flex items-center rounded-lg border border-bpa-200 dark:border-bpa-amber-800 bg-white dark:bg-bpa-950/80 overflow-hidden focus-within:ring-2 focus-within:ring-primary transition"
                >
                  <input
                    v-model="vistaForm.plazoAnios"
                    type="number"
                    min="0"
                    step="0.5"
                    placeholder="0"
                  ...
                  <div class="flex flex-col self-stretch border-l border-bpa-200 dark:border-bpa-amber-800">
                    <button
                      type="button"
                      @click="ajustar(vistaForm, 'plazoAnios', 0.5, 0)"
                      class="flex-1 flex items-center justify-center px-2.5 hover:bg-bpa-50 dark:hover:bg-bpa-800/40 text-muted hover:text-default border-b border-bpa-200 dark:border-bpa-amber-800 transition-colors"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <div
                        @click="inputFechaInicio?.showPicker()"
                    ...
                    <div>
                      ...
                      <div
                        @click="inputFechaFin?.showPicker()"
                        class="flex items-center justify-between rounded-lg border border-bpa-200 dark:border-bpa-amber-800 bg-white dark:bg-bpa-950/80 px-3 py-2 cursor-pointer select-none"
                      >
      ...
      >
        <div v-if="tabActiva === 'plazo'" key="plazo" class="space-y-5">
          ...
          <div class="flex items-center gap-3 flex-wrap">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                v-for="mon in plazoMonedasDisponibles"
                :key="mon.moneda"
                @click="
                  plazoMoneda = mon.moneda;
                  plazoForm.idx = 0;
                "
                class="px-3 py-1.5 rounded-full text-xs font-semibold border transition-colors"
                :class="
          ...
          <div class="overflow-hidden rounded-xl border border-bpa-200 dark:border-bpa-amber-800">
            ...
            <div class="grid bg-white dark:bg-bpa-950/60" :class="clasesGridPlazo">
              <div
                v-for="(tasa, idx) in plazoTasasFiltradas"
                :key="tasa.id"
          ...
          <div>
            ...
            >
              ...
              <div class="flex flex-col self-stretch border-l border-bpa-200 dark:border-bpa-amber-800">
                <button
                  type="button"
                  @click="ajustar(plazoForm, 'monto', 0.1, 0)"
                  class="flex-1 flex items-center justify-center px-2.5 hover:bg-bpa-50 dark:hover:bg-bpa-800/40 text-muted hover:text-default border-b border-bpa-200 dark:border-bpa-amber-800 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div v-if="tabActiva === 'credito'" key="credito" class="space-y-5">
            ...
            <div>
              ...
              >
                ...
                <div class="flex flex-col self-stretch border-l border-bpa-200 dark:border-bpa-amber-800">
                  <button
                    type="button"
                    @click="ajustar(creditoForm, 'monto', 0.1, 0)"
                    class="flex-1 flex items-center justify-center px-2.5 hover:bg-bpa-50 dark:hover:bg-bpa-800/40 text-muted hover:text-default border-b border-bpa-200 dark:border-bpa-amber-800 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              ...
              >
                ...
                <div class="flex flex-col self-stretch border-l border-bpa-200 dark:border-bpa-amber-800">
                  <button
                    type="button"
                    @click="ajustar(creditoForm, 'tasaAnual', 0.1, 0)"
                    class="flex-1 flex items-center justify-center px-2.5 hover:bg-bpa-50 dark:hover:bg-bpa-800/40 text-muted hover:text-default border-b border-bpa-200 dark:border-bpa-amber-800 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              ...
              >
                ...
                <div class="flex flex-col self-stretch border-l border-bpa-200 dark:border-bpa-amber-800">
                  <button
                    type="button"
                    @click="ajustar(creditoForm, 'plazoMeses', 1, 1)"
                    class="flex-1 flex items-center justify-center px-2.5 hover:bg-bpa-50 dark:hover:bg-bpa-800/40 text-muted hover:text-default border-b border-bpa-200 dark:border-bpa-amber-800 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="rounded-xl border border-bpa-200 dark:border-bpa-amber-800 overflow-hidden">
            ...
            <div class="bg-white dark:bg-bpa-950/60 p-5">
              ...
              <div
                class="text-center mb-5 p-4 rounded-xl bg-bpa-50 dark:bg-bpa-950/40 border border-bpa-200 dark:border-bpa-amber-800"
              >
              ...
              <div class="grid grid-cols-3 gap-3">
                ...
                <div class="text-center p-3 rounded-lg bg-bpa-100/50 dark:bg-bpa-amber-950/30">
                  ...
                  <p class="text-sm font-bold text-default dark:text-default">
                    {{ fmt(resultadoCredito?.totalIntereses ?? 0) }}
                  </p>
                </div>
                <div class="text-center p-3 rounded-lg bg-bpa-100/50 dark:bg-bpa-amber-950/30">
                  <p class="text-[11px] text-muted mb-1">{{ tl('labelToPay') }}</p>
                  <p class="text-sm font-bold text-default dark:text-default">
                    {{ fmt(resultadoCredito?.totalPagar ?? 0) }}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div
            v-if="resultadoCredito"
            class="rounded-xl border border-bpa-200 dark:border-bpa-amber-800 overflow-hidden"
          >
            <div
              class="bg-bpa-800 dark:bg-bpa-amber-950 border-b border-bpa-200 dark:border-bpa-amber-800 px-4 py-2.5 flex items-center gap-2 text-white"
            >
              <!-- tabler:table -->
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span class="ml-auto text-xs text-bpa-200 dark:text-bpa-amber-600"
                >{{ resultadoCredito.n }} {{ tl('labelQuotas') }}</span
              >
            </div>
              ...
              <table class="w-full text-sm">
                <thead>
                  <tr class="bg-bpa-50 dark:bg-bpa-950/80 border-b border-bpa-200 dark:border-bpa-amber-800">
                    ...
                    <th class="text-center px-3 py-2.5 text-xs font-semibold text-bpa-400 dark:text-bpa-amber-400">
                      {{ tl('colInterest') }}
                    </th>
                    <th class="text-center px-3 py-2.5 text-xs font-semibold text-bpa-400 dark:text-bpa-amber-400">
                      {{ tl('colCapital') }}
                ...
                <tbody class="divide-y divide-bpa-200 dark:divide-bpa-amber-800/50">
                  <template v-for="(fila, idx) in filasVisibles" :key="idx">
                    ...
                    >
                      ...
                      <td class="text-center px-3 py-2 text-default dark:text-default font-medium">
                        {{ fmt(fila.cuota) }}
                      </td>
                      <td class="text-center px-3 py-2 text-bpa-400 dark:text-bpa-amber-400 font-medium">
                        {{ fmt(fila.interes) }}
                      </td>
                      <td class="text-center px-3 py-2 text-bpa-400 dark:text-bpa-amber-400 font-medium">
                        {{ fmt(fila.capital) }}
            ...
            >
              ...
              >
                {{
                  tablaCompleta ? tl('labelShowLess') : tl('labelShowAll').replace('{n}', String(resultadoCredito.n))
                }}
              </button>
            </div>
          </div>
