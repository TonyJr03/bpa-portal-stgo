...
<template>
  ...
  <div
    v-else-if="errorDB"
    class="rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/30 p-8 text-center"
  >
    <!-- tabler:wifi-off -->
    <svg
  ...
  <div
    v-else-if="!comunicados.length"
    class="rounded-xl border border-bpa-200 dark:border-bpa-amber-800 bg-bpa-50 dark:bg-bpa-950/60 p-10 text-center"
  >
        ...
        <div class="flex items-center justify-between gap-2 flex-wrap">
          <span
            :class="[
              ...
              CONFIG_NIVEL[c.nivel]?.badge ?? CONFIG_NIVEL.informativo.badge,
            ]"
          >
            {{ badgeLabel(c) }}
          </span>
